...
from mymatgen.core.structure import Structure
from mymatgen.symmetry.spacegroup import Spacegroup
from mymatgen.symmetry.structure import SymmetrizedStructure
from mymatgen.core.operations import SymmOp
from mymatgen.core.lattice import Lattice
from mymatgen.core.structure import PeriodicSite
from mymatgen.core.structure_modifier import SupercellMaker

try:
    import mymatgen._spglib as spg
except ImportError:
    try:
