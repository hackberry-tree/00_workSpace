...
from mymatgen.core.periodic_table import get_el_sp, Element
from mymatgen.util.string_utils import formula_double_format
from mymatgen.serializers.json_coders import MSONable
from mymatgen.core.units import unitized

if sys.version_info[0] >= 3:
    basestring = str #pylint: disable=C0103
